            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
                <div class="container d-flex align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?=$shop_page_url?>">Shop</a></li>
                        ...
                        <div class="row">
                                ...
                                <div class="product-gallery">
                                    ...
                                    if ( has_post_thumbnail() ) {
                                        ...
                                        if ( ! empty( $large_image_url[0] ) ) {
                                            echo '<img id="product-zoom" src="'.$large_image_url[0].'" data-zoom-image="'.$large_image_url[0].'" alt="product image">';
                                        }
                                    }
                                    ?>
                                    ...
                                    <div id="product-zoom-gallery" class="product-image-gallery">
                                        <a class="product-gallery-item" href="#" data-image="assets/images/products/single/extended/1.jpg" data-zoom-image="assets/images/products/single/extended/1-big.jpg">
                                            <img src="<?=get_template_directory_uri()?>/assets/images/products/single/extended/1-small.jpg" alt="product side">
                                        </a>
                                        ...
                                        <a class="product-gallery-item" href="#" data-image="assets/images/products/single/extended/2.jpg" data-zoom-image="assets/images/products/single/extended/2-big.jpg">
                                            <img src="<?=get_template_directory_uri()?>/assets/images/products/single/extended/2-small.jpg" alt="product cross">
                                        </a>
                                        ...
                                        <a class="product-gallery-item active" href="#" data-image="assets/images/products/single/extended/3.jpg" data-zoom-image="assets/images/products/single/extended/3-big.jpg">
                                            <img src="<?=get_template_directory_uri()?>/assets/images/products/single/extended/3-small.jpg" alt="product with model">
                                        </a>
                                        ...
                                        <a class="product-gallery-item" href="#" data-image="assets/images/products/single/extended/4.jpg" data-zoom-image="assets/images/products/single/extended/4-big.jpg">
                                            <img src="<?=get_template_directory_uri()?>/assets/images/products/single/extended/4-small.jpg" alt="product back">
                                        </a>
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title"><?php echo get_the_title();?></h1><!-- End .product-title -->
                                    ...
                                    <div class="product-details-action">
                                        <?php 
                                            ...
                                            echo '<button type="submit" class="btn-product btn-cart">Add to Cart</button>';
                                            echo '</form>';
                                        ?> 
                            ...
                            */
                            ...
                            if ($products->have_posts()){
                                while ($products->have_posts()){
                                    $products->the_post();
                                    wc_get_template_part('content', 'product7');
                                }
                            }
                            wp_reset_postdata();
                            // Đặt lại truy vấn sản phẩm
                        ?>
